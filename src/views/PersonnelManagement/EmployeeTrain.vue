  ...
  <div>
      ...
      <div>
        <el-row :gutter="10">
          ...
          <el-col :offset="4" :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="添加培训" placement="top">
          ...
          <!-- 删除培训 按钮
          <el-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="删除培训" placement="top">
          ...
          <!-- 修改培训 按钮
          <el-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="修改培训" placement="top">
          ...
          <!-- 打印培训信息 按钮 -->
          <el-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="打印培训信息" placement="top">
    ...
    <div>
      ...
      >
        ...
        <el-table-column fixed prop="id" label="培训编号" width="100" align="center"></el-table-column>
        ...
        <el-table-column prop="trainDate" label="培训日期" align="center" width="200"></el-table-column>
        <el-table-column prop="trainContent" label="培训内容" align="center" width="300"></el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="内容" prop="trainContent">
          <el-input type="textarea" autosize placeholder="请输入内容" v-model="addForm.trainContent"></el-input>
        </el-form-item>
    ...
    >
      <el-form
        ...
        size="mini"
      >
        <el-form-item label="培训编号" prop="id">
        ...
        <el-form-item label="内容" prop="trainContent">
          <el-input type="textarea" autosize placeholder="请输入内容" v-model="editForm.trainContent"></el-input>
        </el-form-item>
        <el-form-item label="备注" prop="remark">
...
export default {
  ...
  methods: {
    // 访问后端获取表格数据
    async getTableData() {
      const { data: res } = await this.$http.get("/personnel/train", {
        params: this.page,
      });
      //将data数据赋值表格数组
    ...
    Edit(row) {
      ...
      this.editForm.trainDate = row.trainDate;
      this.editForm.trainReason = row.trainReason;
    ...
    async MinusConfirm(row) {
      const { data: res } = await this.$http.delete(
        "/personnel/train?id=" + row.id
      );
      this.$message.success("删除培训编号为" + row.id + "的数据成功");
      // this.getTableData();
    },
    // 删除取消按钮
    MinusCancel() {
