  ...
  <div>
      ...
      <div>
        <el-row :gutter="10">
          ...
          <el-col :offset="4" :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="添加奖惩" placement="top">
          ...
          <!-- 删除奖惩 按钮
          <el-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="删除奖惩" placement="top">
          ...
          <!-- 修改奖惩 按钮
          <el-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="修改奖惩" placement="top">
          ...
          <!-- 打印奖惩信息 按钮 -->
          <el-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="打印奖惩信息" placement="top">
    ...
    <div>
      ...
      >
        ...
        <el-table-column fixed prop="id" label="奖惩编号" width="100" align="center"></el-table-column>
        <el-table-column fixed prop="name" label="姓名" width="150" align="center"></el-table-column>
        <el-table-column prop="eid" label="员工编号" align="center" width="100"></el-table-column>
        <el-table-column prop="ecDate" label="奖惩日期" align="center" width="200"></el-table-column>
        <el-table-column prop="ecReason" label="奖惩原因" align="center" width="150"></el-table-column>
        <el-table-column prop="ecPoint" label="奖惩分" align="center" width="100"></el-table-column>
        <el-table-column prop="ecType" label="奖惩类型" align="center" width="100"></el-table-column>
      ...
      >
        ...
        <el-form-item label="奖惩日期" prop="ecDate">
          <el-date-picker
            type="date"
            placeholder="选择日期"
            v-model="addForm.ecDate"
            style="width: 100%;"
            value-format="yyyy-MM-dd"
          ></el-date-picker>
        </el-form-item>
        <el-form-item label="奖惩原因" prop="ecReason">
          <el-input type="textarea" autosize placeholder="请输入内容" v-model="addForm.ecReason"></el-input>
        </el-form-item>
        <el-form-item label="奖惩分" prop="ecPoint">
          <el-input v-model="addForm.ecPoint" ></el-input>
        </el-form-item>
        <el-form-item label="奖惩类型" prop="ecType">
          <el-input v-model="addForm.ecType" ></el-input>
        </el-form-item>
    ...
    >
      <el-form
        ...
        size="mini"
      >
        <el-form-item label="奖惩编号" prop="id">
        ...
        <el-form-item label="奖惩日期" prop="ecDate">
          <el-date-picker
            type="date"
            placeholder="选择日期"
            v-model="editForm.ecDate"
            style="width: 100%;"
            value-format="yyyy-MM-dd"
          ></el-date-picker>
        </el-form-item>
        <el-form-item label="奖惩原因" prop="ecReason">
          <el-input type="textarea" autosize placeholder="请输入内容" v-model="editForm.ecReason"></el-input>
        </el-form-item>
        <el-form-item label="奖惩分" prop="ecPoint">
          <el-input v-model="editForm.ecPoint" ></el-input>
        </el-form-item>
        <el-form-item label="奖惩类型" prop="ecType">
          <el-input v-model="editForm.ecType" ></el-input>
        </el-form-item>
        <el-form-item label="备注" prop="remark">
...
export default {
  ...
  methods: {
    // 访问后端获取表格数据
    async getTableData() {
      const { data: res } = await this.$http.get("/personnel/ec", {
        params: this.page,
      });
      //将data数据赋值表格数组
    ...
    Edit(row) {
      ...
      this.editForm.ecDate = row.ecDate;
      this.editForm.ecReason = row.ecReason;
      this.editForm.ecPoint = row.ecPoint;
      this.editForm.ecType = row.ecType;
    ...
    async MinusConfirm(row) {
      const { data: res } = await this.$http.delete(
        "/personnel/ec?id=" + row.id
      );
      this.$message.success("删除奖惩编号为" + row.id + "的数据成功");
      // this.getTableData();
    },
    // 删除取消按钮
    MinusCancel() {
