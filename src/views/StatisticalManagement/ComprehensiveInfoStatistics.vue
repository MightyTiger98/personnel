  ...
  <div>
              ...
              <el-form-item label="" prop="name" style="margin:0px">
                <el-input v-model="searchForm.name" >
                  <el-select v-model="select" slot="prepend" placeholder="请选择" style="width:110px">
                    ...
                    <el-option label="出生月份" value="2"></el-option>
                  </el-select>
                </el-input>
              </el-form-item>
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="date" label="出生日期" align="center" width="300"></el-table-column>
        <el-table-column prop="state" label="状态" align="center" width="200"></el-table-column>
      </el-table>
    </div>
  </div>
</template>
