<template>
  ...
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>工作等级</el-breadcrumb-item>
    </el-breadcrumb>
      ...
      <div>
        <el-row :gutter="10">
          ...
          <el-col :offset="4" :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="添加职称" placement="top">
          ...
          <!-- 删除职称 按钮
          <el-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="删除职称" placement="top">
          ...
          <!-- 修改职称 按钮
          <el-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="修改职称" placement="top">
          ...
          <!-- 打印职称信息 按钮 -->
          <el-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="打印职称信息" placement="top">
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="id" label="职称编号" width="100" align="center"></el-table-column>
        <el-table-column prop="name" label="职称名称" width="150" align="center"></el-table-column>
        <el-table-column prop="titleLevel" label="职称等级" align="center" width="200"></el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="职称等级" prop="titlelevel">
          <el-input v-model="addForm.titleLevel" ></el-input>
        </el-form-item>
    ...
    >
      <el-form
        ...
        :inline="true"
      >
        <el-form-item label="职称编号" prop="id">
        ...
        <el-form-item label="职称等级" prop="titleLevel">
          <el-input v-model="editForm.titleLevel" ></el-input>
        </el-form-item>
        <el-form-item label="创立时间" prop="createDate">
          <el-date-picker
            type="date"
...
export default {
  ...
  methods: {
    // 访问后端获取表格数据
    async getTableData() {
      const { data: res } = await this.$http.get("/department/manageJob", {
        params: this.page,
      });
      //将data数据赋值表格数组
    ...
    Edit(row) {
      ...
      this.editForm.titleLevel = row.titleLevel;
    ...
    async MinusConfirm(row) {
      const { data: res } = await this.$http.delete(
        "/department/manageJob?id=" + row.id
      );
      this.$message.success("删除职称编号为" + row.id + "的数据成功");
      // this.getDepartmentInfo();
    },
    // 删除取消按钮
    MinusCancel() {
