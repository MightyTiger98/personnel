      ...
      <div>
        <el-row :gutter="10">
          ...
          <el-col :offset="4" :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="添加调薪" placement="top">
          ...
          <!-- 删除调薪 按钮
          <el-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="删除调薪" placement="top">
          ...
          <!-- 修改调薪 按钮
          <el-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="修改调薪" placement="top">
          ...
          <!-- 打印调薪信息 按钮 -->
          <el-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <el-tooltip class="item" effect="dark" content="打印调薪信息" placement="top">
...
export default {
  ...
  methods: {
    // 访问后端获取表格数据
    async getTableData() {
      const { data: res } = await this.$http.get("/personnel/salary", {
        params: this.page,
      });
      //将data数据赋值表格数组
    ...
    async MinusConfirm(row) {
      const { data: res } = await this.$http.delete(
        "/personnel/salary?id=" + row.id
      );
      this.$message.success("删除调薪编号为" + row.id + "的数据成功");
      // this.getTableData();
    },
    // 删除取消按钮
    MinusCancel() {
